...
namespace APIVerve
{
    public class USDAHardinessZoneAPIClient
    {
        ...
        public USDAHardinessZoneAPIClient(string apiKey, bool isSecure = true)
        {
            _apiKey = apiKey;
            _isSecure = isSecure;
        }
        ...
        public USDAHardinessZoneAPIClient(string apiKey, bool isSecure = true, bool isDebug = false)
        {
            _apiKey = apiKey;
            _isSecure = isSecure;
            _isDebug = isDebug;

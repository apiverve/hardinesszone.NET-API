...
namespace APIVerve
{
    public class HardinessZoneLookupAPIClient
    {
        ...
        public HardinessZoneLookupAPIClient(string apiKey, bool isSecure = true)
        {
            _apiKey = apiKey;
            _isSecure = isSecure;
        }
        ...
        public HardinessZoneLookupAPIClient(string apiKey, bool isSecure = true, bool isDebug = false)
        {
            _apiKey = apiKey;
            _isSecure = isSecure;
            _isDebug = isDebug;
        ...
        public void ExecuteAsync(ExecuteAsyncCallback callback, HardinessZoneLookupQueryOptions options = null)
        {
        ...
        /// <param name="options"></param>
        /// <returns></returns>
        public ResponseObj Execute(HardinessZoneLookupQueryOptions options = null)
        {
            try
            {
                if (_isDebug)
        ...
        private string constructURL(HardinessZoneLookupQueryOptions options)
        {
